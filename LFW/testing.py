# -*- coding: utf-8 -*-
"""
Created on Sun Apr 22 17:36:52 2018

@author: abhilash
"""
#make the classification modular-call it after every iteration-track the difference
...
y_score = clf.score(X_test_pca, FaceRecognition.y_test)
fpr = dict()
tpr = dict()
roc_auc = dict()
